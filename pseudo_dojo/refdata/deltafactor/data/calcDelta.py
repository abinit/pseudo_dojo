# calcDelta.py determines the Delta factor of a code. Current version: 1.2
#
...
# by means of the ground-state elemental crystals", Crit. Rev. Solid State 
# (2013).
#
...
outfile.write('# calculated with calcDelta.py version 1.2 \n')
outfile.write('--------------------\n')
