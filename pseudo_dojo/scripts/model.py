...
pseudos = multi.change_icmod3(fcfact_list=(6.0, 7.0, 8.0), rcfact_list=(1.15, 1.17, 1.19, 1.21, 1.23, 1.25))
#pseudos = multi.change_icmod3(fcfact_list=(9.0, 10.0, 12.0), rcfact_list=(1.05, 1.07, 1.09, 1.01, 1.03, 1.05))
